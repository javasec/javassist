...
package org.javaweb.javassist.bytecode.stackmap;
...
import org.javaweb.javassist.bytecode.ByteArray;
...
public class MapMaker extends Tracer {
    ...
    public static void main1(String className) throws Exception {
        ...
        //org.javaweb.javassist.CtClass cc = cp.get(className);
        org.javaweb.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(className));
    ...
    public static void main2(String[] args) throws Exception {
        ClassPool cp = ClassPool.getDefault();
        //org.javaweb.javassist.CtClass cc = cp.get(args[1]);
        org.javaweb.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(args[1]));
        MethodInfo minfo;
