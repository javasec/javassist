 ...
 *
 * <pre>% java web.tools.org.javaweb.javassist.Viewer <i>host port</i> Main arg1, ...</pre>
 *
...
public class Viewer extends ClassLoader {
    ...
    public static void main(String[] args) throws Throwable {
        if (args.length >= 3) {
            ...
            System.err.println(
        "Usage: java web.tools.org.javaweb.javassist.Viewer <host> <port> class [args ...]");
    }
    ...
    protected Class<?> findClass(String name) throws ClassNotFoundException {
        ...
        if (name.startsWith("java.") || name.startsWith("javax.")
            || name.equals("web.tools.org.javaweb.javassist.Viewer"))
