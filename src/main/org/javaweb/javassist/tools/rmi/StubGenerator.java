...
package org.javaweb.javassist.tools.rmi;
...
import org.javaweb.javassist.CtNewConstructor;
...
public class StubGenerator implements Translator {
    ...
    private static final String sampleClass = "rmi.tools.org.javaweb.javassist.Sample";
     ...
     * This is a method declared in org.javaweb.javassist.Translator.
     *
    ...
    public void start(ClassPool pool) throws NotFoundException {
        ...
        proxyConstructorParamTypes
            = pool.get(new String[] { "rmi.tools.org.javaweb.javassist.ObjectImporter",
                                         "int" });
        interfacesForProxy
            = pool.get(new String[] { "java.io.Serializable",
                                         "rmi.tools.org.javaweb.javassist.Proxy" });
        exceptionForProxy
            = new CtClass[] { pool.get("rmi.tools.org.javaweb.javassist.RemoteException") };
    }
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtField f
            = new CtField(classPool.get("rmi.tools.org.javaweb.javassist.ObjectImporter"),
                          fieldImporter, proxy);
