 ...
 * without <code>reflect.tools.org.javaweb.javassist.Loader</code>
...
public class Compiler {
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (entries[i].metaobject != null
                ...
                if (entries[i].metaobject == null)
                    metaobj = "reflect.tools.org.javaweb.javassist.Metaobject";
                else
                    metaobj = entries[i].metaobject;

                if (entries[i].classobject == null)
                    classobj = "reflect.tools.org.javaweb.javassist.ClassMetaobject";
                else
    ...
    private static void help(PrintStream out) {
        out.println("Usage: java reflect.tools.org.javaweb.javassist.Compiler");
