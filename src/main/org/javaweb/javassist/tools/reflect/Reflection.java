...
public class Reflection implements Translator {
    ...
    static final String metaobjectClassName = "reflect.tools.org.javaweb.javassist.Metaobject";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        classPool = pool;
        final String msg
            = "reflect.tools.org.javaweb.javassist.Sample is not found or broken.";
        try {
            CtClass c = classPool.get("reflect.tools.org.javaweb.javassist.Sample");
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtClass mlevel = classPool.get("reflect.tools.org.javaweb.javassist.Metalevel");
        ...
        CtField f;
        if (addMeta) {
            f = new CtField(classPool.get("reflect.tools.org.javaweb.javassist.Metaobject"),
        ...
        f = new CtField(classPool.get("reflect.tools.org.javaweb.javassist.ClassMetaobject"),
