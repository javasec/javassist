...
public class DefineClassHelper {
    ...
    private static class Java9 extends Helper {
        final class ReferencedUnsafe {
                ...
                throws ClassFormatError
            {
                ...
                try {
                    return (Class<?>) ReflectionUtils.invokeMethod(defineClass, "invokeWithArguments",
        ...
        private final ReferencedUnsafe getReferencedUnsafe() {
            ...
            try {
                ...
                Object   lookup             = ReflectionUtils.invokeStaticMethod(methodHandlesClass, "lookup", new Class[0]);

                Object meth = ReflectionUtils.invokeMethod(
        ...
        throws CannotCompileException
    {
        try {
            ...
            Class<?> methodHandlesClass = Class.forName("java.lang.invoke.MethodHandles");
            Object   getModule          = ReflectionUtils.invokeStaticMethod(DefineClassHelper.class, "getModule", new Class[0]);
            Object   neighborModule     = ReflectionUtils.invokeStaticMethod(neighbor, "getModule", new Class[0]);
            ReflectionUtils.invokeMethod(getModule, "addReads", new Class[]{moduleClass}, neighborModule);

            Object lookup = ReflectionUtils.invokeStaticMethod(methodHandlesClass, "lookup", new Class<?>[0]);

            Object prvlookup = ReflectionUtils.invokeStaticMethod(
    ...
    {
        try {
            return (Class<?>) ReflectionUtils.invokeMethod(lookup, "defineClass", new Class[]{byte[].class}, new Object[]{bcode});
        } catch (IllegalAccessException  e) {
        ...
        throws CannotCompileException
    {
        try {
            Class<?> methodHandlesClass = Class.forName("java.lang.invoke.MethodHandles");
            Object   lookup             = ReflectionUtils.invokeStaticMethod(methodHandlesClass, "lookup", new Class<?>[0]);
            lookup = ReflectionUtils.invokeMethod(lookup, "dropLookupMode", new Class[]{int.class}, Modifier.PRIVATE);

            return (Class<?>) ReflectionUtils.invokeMethod(lookup, "defineClass", new Class[]{byte[].class}, bcode);
        }
        catch (Throwable t) {
